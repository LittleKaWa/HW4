...
public class Lesson_4_1 {
    ...
    public static int medicHealthing= 35;
    ...
    public static void heroesHealthing() {
        boolean wasHealing = false;
        for (int i = 0; i < heroesHealth.length; i++) {
            Random random = new Random();
            int randomIndex = random.nextInt(heroesHealth.length);
            if (medicHealth > 0 && heroesHealth[randomIndex] > 0 && heroesHealth[randomIndex] < 100 && !wasHealing) {
                heroesHealth[randomIndex] = heroesHealth[randomIndex] + medicHealthing;
                wasHealing = true;
                System.out.println("Healthing:" + heroesAttackType[randomIndex]);
            }
    ...
    public static void printStatistics() {
        ...
        System.out.println("Medic health: " + medicHealth + " healing: " + medicHealthing);
    }
}
